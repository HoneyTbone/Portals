...
{
	internal static class ComponentHeaderGUIUtility
	{
        private static readonly GUIContent tooltip = new GUIContent("", "");

        internal static void BeginComponentHeader(Component component, Rect headerRect, bool headerIsSelected, bool headerSupportsRichText)
		{
